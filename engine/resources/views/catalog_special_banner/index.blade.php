...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Catalog SpeCial Deal Banner</h1>
                    <a class="btn btn-primary mt-3" href="{{route('catalog_special_banner.create')}}">Add New Special Deal Banner</a>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Cms</a></li>
                        <li class="breadcrumb-item active">catalog special deal banner</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" tabindex="-1"
                                                    href="{{route('catalog_special_banner.edit', $banner->id)}}">Edit</a>
                                                <a class="dropdown-item" tabindex="-1" href="#"
                                                    onclick="destroy({{$banner->id}})">Delete</a>
                                            </div>
                                            <form method="POST" id="formdelete-{{$banner->id}}"
                                                action="{{route("catalog_special_banner.destroy",$banner->id)}}">
                                                @csrf
                                                @method("delete")
                                            </form>
                                        </td>
